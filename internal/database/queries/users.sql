...
VALUES ($1, $2, $3, COALESCE(NULLIF(@api_token, ''), encode(gen_random_bytes(16), 'hex')), $5, $6, $7, $8, now())
RETURNING *;
...
-- name: UsersGetByMattermostID :one
SELECT * FROM users WHERE mattermost_id = @id::text;
